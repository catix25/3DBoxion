...
import { Box, ImageIcon, Mail, Bell, RefreshCw, Printer, Smartphone } from "lucide-react"
...
export function Sidebar({ activeTab, onTabChange }: SidebarProps) {
  const tabs = [
    ...
    { id: "icons", icon: Smartphone, label: "Iconos 3D", color: "from-cyan-500 to-cyan-600" },
      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`w-12 h-12 rounded-2xl p-0 transition-all duration-300 transform hover:scale-110 flex items-center justify-center ${
              isActive
